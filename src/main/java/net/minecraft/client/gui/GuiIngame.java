...
import dev.emperor.event.rendering.EventDrawText;
import dev.emperor.event.rendering.EventRender2D;
import dev.emperor.module.modules.render.Health;
import dev.emperor.module.modules.render.PostProcessing;
import dev.emperor.utils.render.ScaffoldCounter;
...
extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        PostProcessing postProcessing = Client.instance.moduleManager.getModule(PostProcessing.class);
        ...
        if (this.titlesTimer > 0) {
            ...
            if ((i2 = MathHelper.clamp_int(i2, 0, 255)) > 8) {
                ...
                this.getFontRenderer().drawString(this.displayedSubTitle, -this.getFontRenderer().getStringWidth(this.displayedSubTitle) / 2, Client.instance.moduleManager.getModule(Health.class).getState() ? 25.0f : 5.0f, 0xFFFFFF | j22, true);
                GlStateManager.popMatrix();
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
