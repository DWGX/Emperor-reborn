...
public abstract class GuiSlot {
    ...
    public int getSlotIndexFromScreenCoords(int p_148124_1_, int p_148124_2_) {
        ...
        return p_148124_1_ < this.getScrollBarX() && p_148124_1_ >= i && p_148124_1_ <= j2 && l2 >= 0 && k2 >= 0 && l2 < this.getSize() ? l2 : -1;
    }
    ...
    public void drawScreen(int mouseXIn, int mouseYIn, float p_148128_3_) {
        ...
        this.amountScrolled = SmoothScrollingEverywhere.handleScrollingPosition(target2, this.amountScrolled, this.func_148135_f(), 20.0f / (float)Minecraft.getDebugFPS(), this.start, this.duration);
        ...
        if (this.field_178041_q) {
            ...
            int j2 = i + 6;
            this.bindAmountScrolled();
            this.amountScrolled = SmoothScrollingEverywhere.clamp(this.amountScrolled, this.func_148135_f());
            this.target = SmoothScrollingEverywhere.clamp(this.target, this.func_148135_f());
    ...
    public void handleMouseInput() {
        if (this.isMouseYWithinSlotBounds(this.mouseY)) {
            if (Mouse.getEventButton() == 0 && Mouse.getEventButtonState() && this.mouseY >= this.top && this.mouseY <= this.bottom) {
                ...
                int l2 = k2 / this.slotHeight;
                if (l2 < this.getSize() && this.mouseX >= i && this.mouseX <= j2 && l2 >= 0 && k2 >= 0) {
                    this.elementClicked(l2, false, this.mouseX, this.mouseY);
                    this.selectedElement = l2;
                } else if (this.mouseX >= i && this.mouseX <= j2 && k2 < 0) {
            ...
            if (Mouse.isButtonDown((int)0) && this.getEnabled()) {
                this.target = this.amountScrolled = SmoothScrollingEverywhere.clamp(this.amountScrolled, this.func_148135_f(), 0.0f);
            } else {
    ...
    protected void drawSelectionBox(int p_148120_1_, int p_148120_2_, int mouseXIn, int mouseYIn) {
        ...
        for (int j2 = 0; j2 < i; ++j2) {
            ...
            if (this instanceof GuiResourcePackList && (k2 < this.top - this.slotHeight || k2 > this.bottom)) continue;
