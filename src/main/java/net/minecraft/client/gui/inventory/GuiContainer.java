...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (stealer.getState() && ((Boolean)stealer.silentValue.getValue()).booleanValue()) {
            if (guiScreen instanceof GuiChest) {
                GuiChest chest = (GuiChest)guiScreen;
                if (!((Boolean)stealer.silentValue.getValue()).booleanValue() || chest.lowerChestInventory != null) {
                    mc.setIngameFocus();
