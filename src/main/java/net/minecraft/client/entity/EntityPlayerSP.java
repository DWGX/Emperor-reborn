...
import dev.emperor.event.misc.EventChat;
import dev.emperor.event.misc.EventDisplayChest;
import dev.emperor.event.misc.EventSilentMove;
import dev.emperor.event.world.EventMotion;
import dev.emperor.event.world.EventMove;
...
import dev.emperor.module.modules.player.FastEat;
