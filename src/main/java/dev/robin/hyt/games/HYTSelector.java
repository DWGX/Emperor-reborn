 ...
 */
package dev.robin.hyt.games;
import dev.robin.Client;
import dev.robin.hyt.Interface;
import dev.robin.hyt.animation.Animation;
import dev.robin.hyt.animation.ColorAnimation;
import dev.robin.hyt.animation.Type;
import dev.robin.hyt.game.GermMenuItem;
import dev.robin.hyt.game.GermModProcessor;
