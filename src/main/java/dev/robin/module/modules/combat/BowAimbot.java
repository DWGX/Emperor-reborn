...
extends Module {
    ...
    private EntityLivingBase getTarget() {
        Stream<EntityPlayer> stream = BowAimbot.mc.theWorld.playerEntities.stream().filter(e -> !Teams.isSameTeam(e)).filter(e -> !AntiBot.isServerBot(e)).filter(BowAimbot.mc.thePlayer::canEntityBeSeen).filter(e -> BowAimbot.isFovInRange(e, ((Double)fov.getValue()).floatValue()));
