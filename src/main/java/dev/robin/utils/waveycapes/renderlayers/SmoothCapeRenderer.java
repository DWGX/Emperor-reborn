package dev.robin.utils.waveycapes.renderlayers;

import dev.robin.utils.waveycapes.CapeMovement;
import dev.robin.utils.waveycapes.config.Config;
import dev.robin.utils.waveycapes.renderlayers.CustomCapeRenderLayer;
import dev.robin.utils.waveycapes.sim.StickSimulation;
import dev.robin.utils.waveycapes.util.Matrix4f;
import dev.robin.utils.waveycapes.util.Mth;
import dev.robin.utils.waveycapes.util.PoseStack;
import dev.robin.utils.waveycapes.util.Vector3f;
import dev.robin.utils.waveycapes.util.Vector4f;
