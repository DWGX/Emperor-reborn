package dev.robin.utils.client.menu.utils;
...
public class MainMenuBackground {
    ...
    public MainMenuBackground(String fragmentShaderLocation) throws IOException {
        ...
        GL20.glAttachShader((int)program, (int)this.createShader(MainMenuBackground.class.getResourceAsStream("/assets/minecraft/express/shader/passthrough.vsh"), 35633));
        GL20.glAttachShader((int)program, (int)this.createShader(MainMenuBackground.class.getResourceAsStream(fragmentShaderLocation), 35632));
    ...
    public void useShader(int width, int height, float time) {
        ...
        GL20.glUniform2f((int)this.mouseUniform, (float)width, (float)(1.0f - (float)height));
