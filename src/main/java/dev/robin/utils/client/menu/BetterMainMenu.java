package dev.robin.utils.client.menu;

import dev.robin.gui.altmanager.ColorUtils;
import dev.robin.gui.altmanager.GuiAltManager;
import dev.robin.gui.clickgui.book.RippleAnimation;
import dev.robin.utils.client.menu.button.MenuButton;
import dev.robin.utils.client.menu.utils.MainMenuBackground;
import dev.robin.utils.misc.MinecraftInstance;
import dev.robin.utils.misc.MouseUtils;
...
import dev.robin.utils.render.animation.impl.DecelerateAnimation;
...
implements MinecraftInstance {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        FontManager.lettuceFont20.drawStringWithShadow("Made with     by Robin dev team", 1.0f, this.height - 10, Color.WHITE.getRGB());
