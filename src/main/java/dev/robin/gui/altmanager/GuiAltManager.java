...
import dev.robin.gui.altmanager.GuiAltLogin;
import dev.robin.gui.altmanager.altimpl.MicrosoftAlt;
import dev.robin.gui.altmanager.microsoft.GuiMicrosoftLogin;
import dev.robin.gui.altmanager.microsoft.MicrosoftLogin;
                    ...
                    Thread thread = new Thread(){
                        ...
                        public void run() {
                            try {
                                ...
                                e.printStackTrace();
                                status = (Object)((Object)EnumChatFormatting.RED) + "Login failed! " + ((Object)((Object)e)).getClass().getName() + ": " + e.getMessage();
                            }
                            this.interrupt();
                        }
                    };
