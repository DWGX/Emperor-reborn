...
package dev.robin.gui.clickgui.book;

import net.minecraft.client.shader.*;
import org.checkerframework.org.apache.commons.lang3.StringUtils;
import org.lwjgl.compatibility.display.Display;
import dev.robin.*;
import dev.robin.config.*;
import dev.robin.event.rendering.*;
import java.awt.*;
import dev.robin.event.*;
import org.lwjgl.opengl.*;
import dev.robin.module.Module;
import dev.robin.utils.render.fontRender.*;
import net.minecraft.client.gui.*;
import dev.robin.module.modules.render.*;
import org.apache.commons.lang3.*;
import net.minecraft.client.*;
import java.util.*;
import org.lwjgl.input.*;
import net.minecraft.util.*;
import dev.robin.module.values.*;
import dev.robin.utils.render.*;
import dev.robin.utils.*;
import java.math.*;
import javax.imageio.*;
import java.io.*;
import net.minecraft.client.renderer.texture.*;
import java.awt.image.*;
import dev.robin.module.*;
