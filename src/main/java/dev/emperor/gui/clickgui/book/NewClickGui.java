...
package dev.emperor.gui.clickgui.book;

import net.minecraft.client.shader.*;
import org.checkerframework.org.apache.commons.lang3.StringUtils;
import org.lwjgl.compatibility.display.Display;
import dev.emperor.*;
import dev.emperor.config.*;
import dev.emperor.event.rendering.*;
import java.awt.*;
import dev.emperor.event.*;
import dev.emperor.module.Module;
import dev.emperor.utils.render.fontRender.*;
import net.minecraft.client.gui.*;
import dev.emperor.module.modules.render.*;
import net.minecraft.client.*;
import java.util.*;
import org.lwjgl.input.*;
import net.minecraft.util.*;
import dev.emperor.module.values.*;
import dev.emperor.utils.render.*;
import dev.emperor.utils.*;
import java.math.*;
import javax.imageio.*;
import java.io.*;
import net.minecraft.client.renderer.texture.*;
import java.awt.image.*;
import dev.emperor.module.*;
...
public class NewClickGui extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        FontManager.lettuceBoldFont26.drawCenteredString("MENU", (float)(this.x + 60), (float)(this.y + 8), this.getColor(new Color(255, 255, 255, 150)).getRGB());
        if (this.page.isCategoryPage) {
    ...
    private float drawOptions(float my, final Value<?> option, final int mouseX, final int mouseYi) {
        ...
        if (option instanceof BoolValue) {
            ...
            RenderUtil.drawCircle2(x + 125.0f + 5.0f, finalMy + 5.0f, 12.0f, opt.getValue() ? new Color(200,200,200).getRGB() : new Color(128,128,128).getRGB());
            if (opt.getValue()) {
