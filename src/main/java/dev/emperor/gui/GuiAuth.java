...
import dev.emperor.gui.elements.MDUIButton;
import dev.emperor.gui.elements.MessageBox;
import dev.emperor.module.ModuleManager;
import dev.emperor.utils.RotationComponent;
import dev.emperor.utils.VMCheck;
...
extends GuiScreen {
    ...
    @Override
    public void initGui() {
        this.file1 = new File(this.mc.mcDataDir, "Emperor/uid.bin");
