package dev.emperor.utils.waveycapes.renderlayers;

import dev.emperor.utils.waveycapes.CapeMovement;
import dev.emperor.utils.waveycapes.config.Config;
import dev.emperor.utils.waveycapes.sim.StickSimulation;
import dev.emperor.utils.waveycapes.util.Matrix4f;
import dev.emperor.utils.waveycapes.util.Mth;
import dev.emperor.utils.waveycapes.util.PoseStack;
import dev.emperor.utils.waveycapes.util.Vector3f;
import dev.emperor.utils.waveycapes.util.Vector4f;
