package dev.emperor.utils.mobends.pack;
...
import dev.emperor.utils.mobends.client.model.entity.ModelBendsSpider;
import dev.emperor.utils.mobends.client.model.entity.ModelBendsZombie;
...
public class BendsPack {
    ...
    public static void animate(ModelBendsPlayer model, String target, String anim) {
        BendsTarget bendsTarget = BendsPack.getTargetByID(target);
        if (bendsTarget == null) {
            return;
        }
