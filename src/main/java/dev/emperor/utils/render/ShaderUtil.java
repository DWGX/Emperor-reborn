...
import dev.emperor.utils.client.FileUtil;
...
public class ShaderUtil {
    ...
    public ShaderUtil(String fragmentShaderLoc, String vertexShaderLoc) {
        ...
        try {
            ...
            int vertexShaderID = this.createShader(Client.mc.getResourceManager().getResource(new ResourceLocation(vertexShaderLoc)).getInputStream(), 35633);
    ...
    public static void drawQuads(float x2, float y2, float width, float height) {
        GL20.glBegin((int)7);
        GL20.glTexCoord2f((float)0.0f, (float)0.0f);
        GL20.glVertex2f((float)x2, (float)y2);
        GL20.glTexCoord2f((float)0.0f, (float)1.0f);
        GL20.glVertex2f((float)x2, (float)(y2 + height));
        GL20.glTexCoord2f((float)1.0f, (float)1.0f);
        GL20.glVertex2f((float)(x2 + width), (float)(y2 + height));
        GL20.glTexCoord2f((float)1.0f, (float)0.0f);
        GL20.glVertex2f((float)(x2 + width), (float)y2);
        GL20.glEnd();
    }
    ...
    public static void drawQuads() {
        ...
        GL20.glBegin((int)7);
        GL20.glTexCoord2f((float)0.0f, (float)1.0f);
        GL20.glVertex2f((float)0.0f, (float)0.0f);
        GL20.glTexCoord2f((float)0.0f, (float)0.0f);
        GL20.glVertex2f((float)0.0f, (float)height);
        GL20.glTexCoord2f((float)1.0f, (float)0.0f);
        GL20.glVertex2f((float)width, (float)height);
        GL20.glTexCoord2f((float)1.0f, (float)1.0f);
        GL20.glVertex2f((float)width, (float)0.0f);
        GL20.glEnd();
    }
