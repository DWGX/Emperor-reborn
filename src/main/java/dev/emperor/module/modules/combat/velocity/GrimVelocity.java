...
import dev.emperor.event.world.*;
...
public class GrimVelocity
    ...
    public void onPacketSend(EventPacketSend e) {
        ...
        Packet packet = e.getPacket();
        if (Velocity.grimModes.getValue() == velMode.Vertical && ViaLoadingBase.getInstance().getTargetVersion().getVersion() > 47 && !Client.instance.moduleManager.getModule(Disabler.class).getState() && Disabler.modeValue.getValue() != Disabler.mode.Grim && !Disabler.badPacketsF.getValue() && packet instanceof C0BPacketEntityAction && velocityInput) {
